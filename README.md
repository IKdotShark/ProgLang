...
В некоторых других случаях запуск программы осуществляется черзе команду `make <name_of_file>` в частности это относится к 3-ой лабораторной работе после запускаем через ./lab<number_of_lab>_<number_of_exercise>.
